#!/bin/bash
# Script to run Main Trading Bot (for ETHUSDT symbol) with proper Python environment

echo "Starting Main Trading Bot for ETHUSDT..."
...
python3 live_arsenal_horus_integrated.py --live --symbol ETHUSDT