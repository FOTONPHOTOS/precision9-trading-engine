#!/bin/bash
# Script to run Main Trading Bot (for BNBUSDT symbol) with proper Python environment

echo "Starting Main Trading Bot for BNBUSDT..."
...
python3 live_arsenal_horus_integrated.py --live --symbol BNBUSDT