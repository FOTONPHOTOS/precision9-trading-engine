#!/bin/bash
# Script to run Main Trading Bot (for XRPUSDT symbol) with proper Python environment

echo "Starting Main Trading Bot for XRPUSDT..."
...
python3 live_arsenal_horus_integrated.py --live --symbol XRPUSDT